...
int main() {
    ...
    for (int iter = 0; iter < 1000000; ++iter) {
        // OPTIMIZED VERSION 2: string value compare instead of pointer compare
    ...
    std::cout << "Optimized (cache string values): " << std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count() << " ms" << std::endl;
    std::cout << "Dummy: " << dummy << std::endl;
