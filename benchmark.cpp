...
void setup() {
    ...
    g_compartmentDimensions["EC"] = 3;
    g_compartmentDimensions["CP"] = 3;
    g_compartmentDimensions["NM"] = 2;
    g_compartmentDimensions["NU"] = 3;
}
...
int main() {
    ...
    std::cout << "Optimized (cache): " << std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count() << " ms" << std::endl;
    std::cout << "Dummy: " << dummy << std::endl;
